...
functionals = {'exchange': ['S', 'XA', 'B', 'PW91', 'mPW', 'G96',
               ...
               'hybrid': ['B3LYP', 'B3P86', 'B3PW91', 'B1B95', 'mPW1PW91',
                          ...
                          'TPSSh', 'X3LYP'],
               'long_range': ['HSEH1PBE', 'OHSE2PBE', 'OHSE1PBE', 'wB97XD',
                              'wB97', 'wB97X', 'LC-wPBE', 'CAM-B3LYP',
                              'HISSbPBE', 'M11', 'N12SX', 'MN12SX']}


functionals['xc_corr'] = [xc + corr for xc in functionals['exchange']
                          for corr in functionals['correlation']]
...
basis = {'pople': ['STO-3G', '3-21G', '6-21G', '4-31G', '6-31G', '6-311G'],
         ...
         'other': ['D95', 'D95V', 'SHC', 'CEP-4G', 'CEP-31G', 'CEP-121G',
                   'LanL2MB', 'LanL2DZ', 'SDD', 'SDDAll', 'Def2', 'MidiX',
                   'EPR-II', 'EPR-III', 'UGBS', 'MTSmall', 'DGDZVP',
